...
## Purpose
Defines the first local Node.js receiver that polls the remote message API, writes scheduled messages to the connected K20 GT screen, and acknowledges messages only after successful local display.
## Requirements
