# long-text-display-probing Specification

## Purpose
Capture the safety rules, evidence requirements, and documentation expectations for K20 GT long-text, custom-text parameter, segmentation, and lyric/custom display-layer probing.
